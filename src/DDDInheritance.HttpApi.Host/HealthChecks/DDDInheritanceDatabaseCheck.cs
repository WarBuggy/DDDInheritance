...
public class DDDInheritanceDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public DDDInheritanceDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
